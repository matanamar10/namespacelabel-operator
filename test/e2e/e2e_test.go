...
const namespace = "ns-label-operator-assignment-default-scaffold-system"

// serviceAccountName created for the project
const serviceAccountName = "ns-label-operator-assignment-default-scaffold-controller-manager"

// metricsServiceName is the name of the metrics service of the project
const metricsServiceName = "ns-label-operator-assignment-default-scaffold-controller-manager-metrics-service"

// metricsRoleBindingName is the name of the RBAC that will be created to allow get the metrics data
const metricsRoleBindingName = "ns-label-operator-assignment-default-scaffold-metrics-binding"
	...
	Context("Manager", func() {
		...
		It("should ensure the metrics endpoint is serving metrics", func() {
			...
			cmd := exec.Command("kubectl", "create", "clusterrolebinding", metricsRoleBindingName,
				"--clusterrole=ns-label-operator-assignment-default-scaffold-metrics-reader",
		...
		It("should have CA injection for validating webhooks", func() {
			...
			verifyCAInjection := func(g Gomega) {
				cmd := exec.Command("kubectl", "get",
					...
					"namespacelabel-operator-validating-webhook-configuration",
