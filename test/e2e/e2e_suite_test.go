...
var (
	...
	projectImage = "example.com/ns-label-operator-assignment-default-scaffold:v0.0.1"
)
...
func TestE2E(t *testing.T) {
	...
	_, _ = fmt.Fprintf(GinkgoWriter, "Starting ns-label-operator-assignment-default-scaffold integration test suite\n")
